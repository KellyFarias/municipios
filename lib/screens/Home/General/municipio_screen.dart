...
class MunicipioScreenGen extends StatefulWidget {
  final Municipios municipio;
  MunicipioScreenGen(this.municipio);
  @override
  _MunicipioScreenGenState createState() => _MunicipioScreenGenState();
}

final municipioReference = FirebaseDatabase.instance.reference().child('municipios');

class _MunicipioScreenGenState extends State<MunicipioScreenGen> {
